...
######################
infile <- "spl9x.csv"
outfile <- "SPL9signups.csv"
metas <- c("SM OU", "SM UU", "SM RU", "SM NU", "SM DOU", "ORAS OU", "BW OU", "DPP OU", "ADV OU", "GSC OU", "RBY OU")
regex <- c("su?m\\s?ou\\b", "m?uu\\b", "m?ru\\b", "m?nu\\b", "m?dou", "\\boras", "\\bbw", "\\bdpp", "\\badv", "\\bgsc", "\\brby")
